    ...
    <div className="space-y-6 p-4 sm:p-6 lg:p-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <StatCard
          ...
          value={finance.financialHealthScore}
          icon={HeartPulse}
          suffix="/100"
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <GlassCard delay={0.15}>
          ...
          <p
            className={`mt-2 font-display text-xl font-bold ${
              finance.debtToIncomeRatio > 40
                ? 'text-destructive'
                : 'text-success'
            }`}
          >
            {finance.debtToIncomeRatio}%
          </p>
        ...
        <GlassCard delay={0.2}>
          ...
          <p className="mt-2 font-display text-xl font-bold text-gradient">
            {finance.financialIndependenceScore}/100
          </p>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <GlassCard>
          ...
          <div className="flex flex-col items-center">
            <InflationGauge
              value={finance.personalInflationIndex}
            />
        ...
        <GlassCard delay={0.1}>
          ...
          {/* PERFECTLY CONTROLLED HEALTH SCORE LAYOUT */}
          <div className="grid grid-cols-1 items-center gap-8 sm:grid-cols-[180px_minmax(0,1fr)]">
            ...
            <div className="min-w-0 space-y-4 text-sm">
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
                  {finance.monthlySavings > 0
                    ? 'Positive savings rate'
                    : 'Build savings'}{' '}
                  ·{' '}
                  {finance.investmentValue > 0
              ...
              <div>
                ...
                <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
                  {finance.emergencyFund.monthsCovered < 6
                    ? 'Emergency fund below 6 months'
                    : 'Emergency fund healthy'}{' '}
                  ·{' '}
                  {finance.personalInflationIndex > 5.5
                    ? 'High personal inflation'
      ...
      <GlassCard>
        ...
        <div className="mb-4 flex items-center gap-2">
          ...
          <span className="ml-auto rounded-full bg-primary/10 px-2.5 py-0.5 text-xs font-medium text-primary">
            {finance.aiInsights.length} recommendations
          </span>
        </div>
